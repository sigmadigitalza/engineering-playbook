...
**WCAG 2.2 AA is the target, not WCAG 2.1.** WCAG 2.2 added nine new criteria, several of which are common real-world failures: focus appearance (2.4.11), focus not obscured (2.4.11/12), dragging movements (2.5.7), target size minimum (2.5.8), consistent help (3.2.6), redundant entry (3.3.7), accessible authentication (3.3.8/9). Reviews that anchor on 2.1 miss these. The prompt names the criteria it checks so reports are mappable to law and policy (EAA, ADA, Section 508).
